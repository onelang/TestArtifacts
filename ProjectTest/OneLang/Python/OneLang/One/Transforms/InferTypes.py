...
class InferTypes(astTrans.AstTransformer):
    ...
    def visit_variable_with_initializer(self, variable):
        ...
        super().visit_variable_with_initializer(variable)
    ...
    def visit_expression(self, expr):
        ...
        while True:
            new_expr = self.run_transform_round(transformed_expr or expr)
            if new_expr == None or new_expr == transformed_expr:
                break
        ...
        detect_success = self.detect_type(expr2)
